...
public partial class ChaserEnemy : Node2D
{
	public CharacterBody2D _body;
	public int speed = 40;
	...
	{
		_body = GetNode<CharacterBody2D>("EnemyBody");
	}
	public override void _PhysicsProcess(double delta)
	{
		...
		// 	body.GetNode<AnimatedSprite2D>("AnimatedSprite2D").Play("walk");
	...
	public void DealWithDamage(){
		...
		if( player_inattack_zone ){
			if( can_take_damage == true){
				health = health -20;
				_body.GetNode<Timer>("enemy_take_damage_cooldown").Start();
